...
# def update_ax_limits(ax, points_list, circle_centers, radius):
...
def reading_profile_from_airfoil_dat_files(filepath):
    ...
    depth = -float("inf")  # Depth of the profile
    x_depth = None  # Position of the maximum depth
    TE_angle_deg = None  # Angle of the TE
    ...
    # Convert points_list to numpy array
...
def plot_airfoil_with_le_circle(profile_data):
    ...
    info_text = (
        ...
        f"Depth: {profile_data['depth']:.4f}\n"
        f"x_depth: {profile_data['x_depth']:.4f}\n"
    )
...
def plot_airfoil_with_le_circle(profile_data):
    ...
    try:
        ...
        info_text = (
            ...
            f"Depth: {profile_data.get('depth', 0):.4f}\n"
            f"x_depth: {profile_data.get('x_depth', 0):.4f}\n"
        )
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Depth: {profile_data['depth']}")
        print(f"X depth: {profile_data['x_depth']}")
